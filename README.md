# Nguyễn Văn Phát
### Full-Stack Web & Unity Game Developer

I am a software engineer focused on building modular Unity game architectures, real-time multiplayer games, and immersive 3D web platforms. I hold a Bachelor's in **Software Engineering** (Outstanding Graduation Project Award) and am currently completing a Master's in **Computer Science** at the **Industrial University of Ho Chi Minh City**.

---

## 🔗 Let's Connect

[Portfolio Website](https://Phatjiro.github.io/Phatjiro/) &nbsp;·&nbsp; [YouTube Channel](https://www.youtube.com/@phatlaptrinhgame) &nbsp;·&nbsp; [Email](mailto:nguyenvanphat911@gmail.com) &nbsp;·&nbsp; [GitHub Profile](https://github.com/Phatjiro)
...
* **Game Engineering**  
  Unity (C#), Photon Fusion, Mirror, VR/AR Development (Quest 3), Shader Graph, Custom Editor Extensions.
  
* **Web 3D & Frontend**  
  Babylon.js (WebGL), Next.js, Node.js, Javascript/Typescript, WebSockets.
  
* **Backend & ERP Systems**  
  Python, Odoo ERP, Django, REST APIs, Java.
  
* **Infrastructure & Database**  
  PostgreSQL, Redis, Docker, Git / Gitflow, CI/CD.
